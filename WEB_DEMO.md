...
The launcher enables verbose pipeline/LLM logging in its terminal and writes
rotating logs to `logs/cyber-rag.log`. The page calls the same LangGraph
pipeline as the CLI and shows the grounded
